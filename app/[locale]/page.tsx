...
export default async function Home({ params }: { params: { locale: string } }) {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-rose-100 selection:text-rose-900">
      ...
      <main>
        {/* HERO SECTION - Image changée pour concept-value.jpg */}
        ...
        {/* HOW IT WORKS - Section restaurée avec image AR */}
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
              ...
              <div className="relative">
                <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-rose-500 to-rose-600 text-white rounded-2xl flex items-center justify-center text-2xl font-bold shadow-lg group hover:scale-110 transition-transform">1</div>
                <Card className="h-full border-2 border-slate-100 shadow-lg hover:shadow-xl transition-shadow pt-12 hover:border-rose-100">
                  <CardContent className="p-8">
                    <div className="w-16 h-16 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl flex items-center justify-center text-blue-600 mb-6 mx-auto group-hover:scale-110 transition-transform">
              ...
              <div className="relative">
                <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-rose-500 to-rose-600 text-white rounded-2xl flex items-center justify-center text-2xl font-bold shadow-lg group hover:scale-110 transition-transform">2</div>
                <Card className="h-full border-2 border-slate-100 shadow-lg hover:shadow-xl transition-shadow pt-12 hover:border-rose-100">
                  <CardContent className="p-8">
                    <div className="w-16 h-16 bg-gradient-to-br from-rose-50 to-rose-100 rounded-2xl flex items-center justify-center text-[#e11d48] mb-6 mx-auto group-hover:scale-110 transition-transform">
              ...
              <div className="relative">
                <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-rose-500 to-rose-600 text-white rounded-2xl flex items-center justify-center text-2xl font-bold shadow-lg group hover:scale-110 transition-transform">3</div>
                <Card className="h-full border-2 border-slate-100 shadow-lg hover:shadow-xl transition-shadow pt-12 hover:border-rose-100">
                  <CardContent className="p-8">
                    <div className="w-16 h-16 bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl flex items-center justify-center text-emerald-600 mb-6 mx-auto group-hover:scale-110 transition-transform">
            ...
            {/* Section image AR preview avec design responsive */}
        ...
        <section className="py-24 bg-gradient-to-r from-amber-50 via-white to-emerald-50 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 max-w-6xl relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              <div className="bg-white p-8 rounded-3xl border-2 border-emerald-100 shadow-lg text-center hover:shadow-xl transition-shadow">
              ...
              <div className="bg-white p-8 rounded-3xl border-2 border-amber-100 shadow-lg text-center hover:shadow-xl transition-shadow">
              ...
              <div className="bg-white p-8 rounded-3xl border-2 border-blue-100 shadow-lg text-center hover:shadow-xl transition-shadow">
        ...
        {/* LIMITED TIME OFFER SECTION - Section déplacée avant FAQ */}
        <section className="py-24 bg-gradient-to-br from-slate-900 via-purple-900/50 to-slate-800 text-white overflow-hidden relative">
          ...
          <div className="container mx-auto px-4 relative z-10 max-w-5xl text-center">
            ...
            <div className="max-w-3xl mx-auto mb-12">
              ...
              <div className="bg-gradient-to-r from-slate-800 to-slate-900 border border-slate-700 rounded-2xl p-6 mb-10 hover:border-slate-600 transition-colors">
        ...
        {/* FAQ SECTION - Section déplacée après Limited Time Offer */}
        <section className="py-24 bg-gradient-to-b from-slate-50 to-white">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-serif font-bold text-slate-900 mb-6">
                {locale === 'fr' ? (
                  <>Tout sur le<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-rose-400">Pont des Cadenas d'Amour Paris</span></>
                ) : locale === 'zh-CN' ? (
                  <>关于<span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-rose-400">巴黎爱情锁桥</span><br/>的一切</>
                ) : (
                  <>Everything About the<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-rose-400">Love Lock Bridge Paris</span></>
                )}
              </h2>
      ...
      {/* FOOTER - Liens corrigés + design personnel */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-4 gap-10 mb-12">
              ...
              {/* Navigation principale - LIENS CORRIGÉS */}
              <div>
